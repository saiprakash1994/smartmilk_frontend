          ...
          <Container fluid className="uploads-container">
            <Card className="upload-category-card mb-4">
              <Card.Body>
                ...
                <p>
                  The selected upload type is not available for your user role.
                </p>
                <Button variant="primary" onClick={() => navigate("/uploads")}>
                  Go to Uploads
                </Button>
              </Card.Body>
            </Card>
              ...
              <div className="d-flex justify-content-between align-items-center w-100">
                <div className="category-header-content d-flex align-items-center">
                  ...
                  <div className="category-info ms-3">
                    ...
                    <p className="category-description mb-0">
                      Auto-uploading file: <b>{filename}</b>
                      {deviceId ? (
                        <span>
                          {" "}
                          &nbsp;|&nbsp; <b>Device: {deviceId}</b>
                ...
                <Button
                  ...
                  onClick={() =>
                    navigate(location.state?.returnPath || "/ratetable")
                  }
                >
                  Cancel
                </Button>
            ...
            <Row>
              <Col md={4}>
                <div className="guideline-item">
                  ...
                  <h6>File Format</h6>
                  <p>
                    Ensure your files are in the correct format (CSV, etc.) as
                    specified for each upload type.
                  </p>
                </div>
              </Col>
              <Col md={4}>
                <div className="guideline-item">
                  ...
                  <p>
                    Verify that your data meets the required validation criteria
                    before uploading.
                  </p>
                </div>
              </Col>
              <Col md={4}>
                <div className="guideline-item">
                  ...
                  <p>
                    Set appropriate effective dates for rate tables to ensure
